...
const inputPath = 'C:/Users/b0ody/.gemini/antigravity/brain/11f02dcf-c642-431c-bad8-bdb47318fdf2/.user_uploaded/media_1787231701720.jpg';
const outputDir = './public/products';

async function processAnaSukkar() {
  console.log('Processing Ana Sukkar from:', inputPath);
  ...
  while (head < queue.length) {
    ...
    const isBg = (r > 230 && g > 230 && b > 230) || avgBrightness > 235;
    ...
    if (isBg) {
      ...
      visited[idx] = 1;
      const alpha = Math.max(0, Math.min(255, Math.round((235 - avgBrightness) / 20 * 255)));
