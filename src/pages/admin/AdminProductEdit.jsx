...
export default function AdminProductEdit() {
  ...
  return (
    <div className="space-y-6 animate-fade-in text-[#F3EEE5] max-w-4xl mx-auto">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-[#C6A15B]/20 pb-4">
        <div>
          ...
          <h1 className="font-cinzel text-2xl font-bold uppercase">
      ...
      {/* Main Form */}
      <form onSubmit={handleSubmit} className="bg-[#1C120E] border border-[#C6A15B]/30 p-6 sm:p-8 space-y-6 shadow-2xl text-xs font-sans">
        {/* Basic Info */}
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.productName')}</label>
              <input
                type="text"
                required
                value={formData.name}
            ...
            <div>
              <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">Arabic Name (الاسم بالعربية)</label>
              <input
                type="text"
                required
                ...
                className="w-full bg-[#0F0D0C] border border-[#C6A15B]/30 p-2.5 text-[#F3EEE5] font-arabic focus:outline-none"
              />
            </div>
          </div>

          <div>
            <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">Tagline</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">Description & Scent Journey</label>
            <textarea
              rows={4}
              required
        ...
        <div className="space-y-4 pt-4 border-t border-[#C6A15B]/15">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.gender')}</label>
              <select
            ...
            <div>
              <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.family')}</label>
              <select
            ...
            <div>
              <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.status')}</label>
              <select
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            <div>
              <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.price')}</label>
              <input
                type="number"
                required
                min={50}
            ...
            <div>
              <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.originalPrice')}</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.stock')}</label>
              <input
                type="number"
                required
                min={0}
            ...
            <div>
              <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">Discount (%)</label>
              <input
                type="number"
                min={0}
                max={90}
        ...
        <div className="space-y-4 pt-4 border-t border-[#C6A15B]/15">
          ...
          <div>
            <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.topNotes')}</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.heartNotes')}</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">{t('admin.baseNotes')}</label>
            <input
              type="text"
              required
        ...
        <div className="space-y-4 pt-4 border-t border-[#C6A15B]/15">
          ...
          <div>
            <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">Image URLs (Comma Separated)</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-[#C5B8A8] mb-1 uppercase tracking-wider">Available Sizes (Comma Separated)</label>
            <input
              type="text"
          ...
          <div className="flex gap-6 pt-2">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span>Featured Spotlight on Homepage</span>
            </label>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="accent-[#C6A15B]"
              />
              <span>Iconic Best Seller</span>
            </label>
          </div>
        </div>

        <div className="flex gap-4 pt-6 border-t border-[#C6A15B]/20">
          <button
            type="button"
            onClick={() => navigate('/admin/products')}
            className="w-1/3 py-3 luxury-btn-outline text-xs text-center"
          >
            {t('common.cancel')}
          </button>
          <button
            type="submit"
            disabled={loading}
            className="w-2/3 py-3 luxury-btn-gold text-xs font-semibold uppercase tracking-wider flex items-center justify-center gap-2"
          >
