    ...
    <div className="space-y-24 sm:space-y-32 pb-24 animate-fade-in bg-transparent text-[#F8F5F0]">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-36 sm:pt-44 pb-20">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0B] via-[#0A0A0B]/70 to-[#0A0A0B]/90" />
        </div>

        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 border border-[#D4AF37]/40 bg-[#160F0A]/80 backdrop-blur-md shadow-sm">
          ...
          <h1 className="font-cinzel text-4xl sm:text-6xl font-bold tracking-[0.1em] text-[#F8F5F0] uppercase leading-tight">
            {language === 'es' ? 'El Palacio' : 'The Palace'}
          </h1>

          <p className="italic text-xl sm:text-2xl text-[#C5A059] max-w-2xl mx-auto font-serif">
          ...
          <div className="pt-4 flex justify-center gap-4">
            <Link
              ...
              className="px-8 py-3.5 bg-[#D4AF37] hover:bg-[#E5C07B] text-black font-cinzel font-bold text-xs uppercase tracking-[0.2em] transition-all duration-300 shadow-xl"
            >
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <h2 className="font-cinzel text-3xl sm:text-4xl font-bold text-[#F8F5F0] uppercase">
              The Architecture of Scent
            </h2>
            <p className="text-sm sm:text-base text-[#D0C7B8] font-sans leading-relaxed">
            ...
            <p className="text-xs sm:text-sm text-[#8C6D37] font-sans leading-relaxed">
          ...
          <div className="lg:col-span-6">
            <div className="relative aspect-[4/3] border border-[#D4AF37]/25 bg-[#121010] shadow-2xl overflow-hidden group">
              <img
      ...
      <section className="bg-[#0E0A07] border-y border-[#D4AF37]/15 py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-[#160F0A] border border-[#D4AF37]/20 space-y-4">
              <Droplets className="w-8 h-8 text-[#D4AF37]" />
              <h3 className="font-cinzel text-base font-bold text-[#F8F5F0]">High Concentration Extraits</h3>
            ...
            <div className="p-8 bg-[#160F0A] border border-[#D4AF37]/20 space-y-4">
              ...
              <h3 className="font-cinzel text-base font-bold text-[#F8F5F0]">Aged Artisanal Bakhoor</h3>
              <p className="text-xs text-[#BFA893] leading-relaxed">
            ...
            <div className="p-8 bg-[#160F0A] border border-[#D4AF37]/20 space-y-4">
              ...
              <h3 className="font-cinzel text-base font-bold text-[#F8F5F0]">Numbered Flacon Provenance</h3>
              <p className="text-xs text-[#BFA893] leading-relaxed">
      ...
      <section className="text-center max-w-2xl mx-auto px-4 space-y-6 pt-6">
        ...
        <Link
          to="/shop"
          className="inline-block px-10 py-4 bg-[#D4AF37] hover:bg-[#E5C07B] text-black font-cinzel font-bold text-xs uppercase tracking-[0.25em] transition-all duration-300 shadow-2xl"
        >
          Enter the Boutique
        </Link>
      </section>
