  ...
  return (
    <section id="boutiques" className="py-20 sm:py-32 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 select-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            return (
              <button
                ...
                className={`w-full text-start p-4 sm:p-5 rounded-2xl border transition-all duration-300 flex items-center justify-between cursor-pointer group ${
                  isActive
                    ? 'bg-[#21130D] border-[#D4AF37] shadow-[0_4px_25px_rgba(201,161,92,0.2)]'
                    : 'bg-[#0B0A08]/60 border-white/[0.06] hover:border-white/20 hover:bg-[#0B0A08]'
                }`}
                data-cursor="view"
              >
                <div>
                ...
                <div
                  className={`w-2 h-2 rounded-full transition-all ${
                    isActive ? 'bg-[#D4AF37] shadow-[0_0_8px_#D4AF37]' : 'bg-white/20'
                  }`}
                />
              </button>
            );
        ...
        <div className="lg:col-span-8 bg-[#0B0A08] border border-white/[0.08] rounded-3xl p-6 sm:p-10 flex flex-col justify-between shadow-2xl relative overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/[0.08] pb-6">
              <div>
                ...
                <h3 className="font-arabic font-bold text-2xl sm:text-3xl text-[#F3E6D0] mt-1">
              ...
              <button
                ...
                className="px-6 py-3 rounded-full bg-[#D4AF37] hover:bg-[#F2D675] text-[#0B0A08] font-sans text-xs font-bold uppercase tracking-[0.18em] transition-all shadow-lg hover:scale-105 active:scale-95 cursor-pointer flex items-center justify-center gap-2"
                data-cursor="view"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
              ...
              <div className="flex items-start gap-3.5 text-xs text-[#D8BE99]">
                <MapPin className="w-4 h-4 text-[#D4AF37] flex-shrink-0 mt-0.5" />
                <div>
                  <span className="text-[#D8BE99] uppercase tracking-wider text-[10px] font-sans block">
                    {isArabic ? 'العنوان' : 'ADDRESS'}
                  </span>
                  <p className="font-sans font-medium text-sm text-[#F3E6D0] mt-0.5">
              ...
              <div className="flex items-start gap-3.5 text-xs text-[#D8BE99]">
                ...
                <div>
                  ...
                  <p className="font-sans font-medium text-xs text-[#F3E6D0] mt-0.5">
              ...
              <div className="flex items-start gap-3.5 text-xs text-[#D8BE99]">
                ...
                <div>
                  ...
                  <p className="font-mono font-medium text-sm text-[#F3E6D0] mt-0.5 dir-ltr">
              ...
              <div className="flex items-start gap-3.5 text-xs text-[#D8BE99]">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="font-sans font-semibold text-xs text-[#D4AF37] hover:text-[#F2D675] transition-colors mt-0.5 inline-block"
                  >
          ...
          <div className="mt-8 pt-6 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between text-xs text-[#D8BE99] gap-2">
      ...
      {bookingModalOpen && (
        <div className="fixed inset-0 z-[100] bg-black/85 backdrop-blur-xl flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-[#21130D] border border-[#D4AF37]/40 rounded-3xl p-6 sm:p-10 max-w-lg w-full shadow-2xl relative">
            
            <button
              onClick={() => setBookingModalOpen(false)}
              className="absolute top-6 end-6 text-[#D8BE99] hover:text-[#F3E6D0] transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            {bookingSuccess ? (
              <div className="text-center py-8 space-y-4 animate-fadeIn">
                ...
                <h3 className="font-arabic font-bold text-2xl text-[#F3E6D0]">
                  {isArabic ? 'تم تأكيد طلب موعدك بنجاح' : 'Appointment Request Received'}
                </h3>
                <p className="text-xs text-[#D8BE99] max-w-xs mx-auto">
                  {isArabic
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-4">
                ...
                <div className="space-y-3 pt-2">
                  <div>
                    <label className="text-[11px] text-[#D8BE99] block mb-1">
                    ...
                    <input
                      ...
                      className="w-full bg-[#0B0A08] border border-white/15 rounded-xl px-4 py-2.5 text-xs text-[#F3E6D0] focus:border-[#D4AF37] focus:outline-none"
                    />
                  </div>
                ...
                <button
                  type="submit"
                  className="w-full mt-4 py-3.5 rounded-full bg-[#D4AF37] hover:bg-[#F2D675] text-[#0B0A08] text-xs font-sans font-bold uppercase tracking-widest transition-all shadow-lg cursor-pointer"
                >
