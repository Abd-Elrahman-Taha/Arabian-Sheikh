...
export default function BrandStorySection() {
  ...
  return (
    <section className="py-24 sm:py-36 border-y border-white/[0.06] bg-[#070605] relative overflow-hidden select-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            ...
            <div className="flex items-center gap-3">
              <span className="w-8 h-[1px] bg-[#C9A15C]" />
            ...
            <h2 className="font-arabic font-extralight text-4xl sm:text-6xl lg:text-7xl text-[#F4F1EA] leading-[1.15] tracking-tight">
              {isArabic ? (
                <>
                  مِنْ قَلْبِ الشَّرْق، <br />
                  <span className="font-bold text-[#E5C07B] italic">نَصُوغُ أَثَراً</span> لَا يُنْسَى.
                </>
              ) : (
                <>
                  FROM THE HEART OF ARABIA, <br />
                  <span className="font-bold text-[#E5C07B] italic">WE CRAFT AN UNFORGETTABLE</span> PRESENCE.
                </>
              )}
            </h2>

            {/* Craftsmanship Paragraph with High Line-Height */}
            <p className="font-sans font-light text-sm sm:text-base text-[#B9B3A8] max-w-2xl leading-[1.9]">
              {isArabic
            ...
            <div className="pt-4">
              <Link
                to="/the-house"
                className="inline-flex items-center gap-3 px-8 py-3.5 rounded-full border border-[#C9A15C]/40 bg-[#C9A15C]/10 hover:bg-[#C9A15C] hover:text-[#050505] text-[#E5C07B] text-xs font-sans font-bold uppercase tracking-[0.2em] transition-all duration-300 shadow-lg group hover:scale-105"
                data-cursor="explore"
              >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-8 sm:p-10 rounded-3xl bg-[#0D0C0A] border border-white/[0.08] shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="flex items-center gap-3 pb-4 border-b border-white/[0.06]">
                  <Crown className="w-5 h-5 text-[#C9A15C]" />
                  <span className="text-xs font-sans font-bold uppercase tracking-widest text-[#F4F1EA]">
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div>
                    <span className="text-3xl sm:text-4xl font-mono font-bold text-[#C9A15C] block">
                      38%
                    </span>
                    <span className="text-xs font-sans text-[#F4F1EA] font-semibold block mt-0.5">
                      {isArabic ? 'تركيز الزيت العطري الخالص (Extrait)' : 'Pure Oil Concentration'}
                    </span>
                    <span className="text-[11px] text-[#8E8880] block">
