...
const DepthCarousel = ({
  ...
  const layout = useCallback(pos => {
    ...
    for (let i = 0; i < n; i++) {
      ...
      if (ov) ov.style.opacity = clamp(back * cfg.falloff * 1.25, 0, 0.82).toFixed(3);
    }
  }, []);
  ...
  const onCardClick = useCallback(
    (index, e) => {
      ...
      // If clicking interactive buttons inside the card, allow their own handlers
