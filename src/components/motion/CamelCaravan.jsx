...
export default function CamelCaravan({
  ...
  const CamelSvg = ({ isLeader = false, saddleColor = '#3A2116', accentColor = '#D4AF37' }) => (
    <svg
      viewBox="0 0 160 100"
    ...
    >
      <defs>
        ...
        <linearGradient id="camelCoat" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#D8BE99" />
          <stop offset="35%" stopColor="#D8BE99" />
          <stop offset="75%" stopColor="#D8BE99" />
          <stop offset="100%" stopColor="#3A2116" />
        </linearGradient>

        {/* Back Legs / Shadow Gradient */}
        <linearGradient id="camelShadow" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#3A2116" />
          <stop offset="100%" stopColor="#3A2116" />
        </linearGradient>
        ...
        <linearGradient id="camelHighlight" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#D8BE99" />
          <stop offset="100%" stopColor="#D8BE99" />
        </linearGradient>
      </defs>
      ...
      <rect x="68" y="87" width="5" height="3" rx="1" fill="#21130D" />

      {/* Back-Right Hindleg */}
      <path d="M26 68 L28 88 L23 88 L22 68 Z" fill="url(#camelShadow)" />
      <rect x="23" y="86" width="5" height="3" rx="1" fill="#21130D" />

      {/* Tail with Fur Tuft */}
      <path d="M14 60 Q8 68 11 76 Q12 79 10 82" fill="none" stroke="#3A2116" strokeWidth="2.2" strokeLinecap="round" />
      <path d="M10 79 Q7 83 11 86 Q13 83 10 79 Z" fill="#3A2116" />
      ...
      <rect x="70" y="87" width="6" height="3.5" rx="1" fill="#21130D" />
      <rect x="46" y="87" width="6" height="3.5" rx="1" fill="#21130D" />
      <rect x="26" y="87" width="6" height="3.5" rx="1" fill="#21130D" />
      <rect x="12" y="87" width="6" height="3.5" rx="1" fill="#21130D" />

      {/* Lighter Snout / Muzzle */}
      <path d="M114 15 Q120 14 122 19 Q123 23 118 25 Q115 22 114 15 Z" fill="url(#camelHighlight)" />
      {/* Eye */}
      <ellipse cx="114" cy="18" rx="1.6" ry="1.2" fill="#21130D" />
      {/* Nostril & Mouth Line */}
      <circle cx="120" cy="19.5" r="0.8" fill="#3A2116" />
      <path d="M117 23 Q121 23 122 20" fill="none" stroke="#3A2116" strokeWidth="0.8" />
      {/* Small Ear */}
      <polygon points="107,17 110,12 111,18" fill="#3A2116" />
      ...
      <circle cx="41" cy="62" r="1.5" fill="#F3E6D0" />
      <circle cx="48" cy="62" r="1.5" fill="#F3E6D0" />
      <circle cx="55" cy="62" r="1.5" fill="#F3E6D0" />
      {/* Wooden Saddle Pommel / Horns */}
      <rect x="62" y="34" width="3" height="8" rx="1" fill="#3A2116" transform="rotate(-15 62 34)" />
      <rect x="47" y="34" width="3" height="8" rx="1" fill="#3A2116" transform="rotate(15 47 34)" />

      {/* Arabian Leather Bridle & Halter Straps */}
      <path d="M113 18 L116 26 L111 28 L108 20 Z" fill="none" stroke="#3A2116" strokeWidth="1.2" />
      ...
      {isLeader && (
        <g transform="translate(132, 18)">
          {/* Head & Keffiyeh */}
          <ellipse cx="11" cy="23" rx="4.5" ry="5.5" fill="#F3E6D0" />
          <path d="M6 25 Q11 28 16 25 L15 35 L7 35 Z" fill="#F3E6D0" />
          {/* Black Agal */}
          <ellipse cx="11" cy="20.5" rx="4.2" ry="1.2" fill="#21130D" />
          <ellipse cx="11" cy="22" rx="4.2" ry="1.2" fill="#21130D" />

          {/* Flowing Cream & Gold Royal Bisht Robe */}
          <path d="M7 32 L15 32 L19 64 L3 64 Z" fill="#F3E6D0" />
          <line x1="11" y1="32" x2="11" y2="64" stroke="#D4AF37" strokeWidth="1.4" />
          
          {/* Wooden Walking Staff */}
          <line x1="20" y1="18" x2="21" y2="68" stroke="#3A2116" strokeWidth="2.2" strokeLinecap="round" />
          <circle cx="20" cy="18" r="1.5" fill="#D4AF37" />

          {/* Golden Lead Rein back to Camel's Halter */}
          <path d="M4 42 Q-6 45 -16 26" fill="none" stroke="#D4AF37" strokeWidth="1.4" strokeDasharray="3,1.5" />
        </g>
      )}

      {/* Caravan Hitch Rope connecting to trailing camel behind on left */}
      {!isLeader && (
        <path d="M-26 50 Q-10 58 10 60" fill="none" stroke="#D4AF37" strokeWidth="1.4" strokeDasharray="3.5,2" />
      )}
    </svg>
  );
      ...
      >
        <defs>
          ...
          <linearGradient id="duneFront" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#D8BE99" />
            <stop offset="25%" stopColor="#3A2116" />
        ...
        <path d="M0 82 Q480 32 960 68 T1440 50" fill="none" stroke="#D4AF37" strokeWidth="1.5" opacity="0.6" />
      </svg>
      ...
      <div className="relative w-full h-36 sm:h-48 md:h-56">
        ...
        >
          <div className="animate-camel-gait">
            <CamelSvg isLeader={true} saddleColor="#3A2116" accentColor="#D4AF37" />
          </div>
        </div>

        {/* Camel 2 (Trailing 1 - Rich Espresso) */}
        <div
          className="absolute bottom-4 sm:bottom-6 animate-caravan-walk"
          style={{
        ...
        >
          <div className="animate-camel-gait" style={{ animationDelay: '-0.7s' }}>
            <CamelSvg isLeader={false} saddleColor="#21130D" accentColor="#D4AF37" />
          </div>
        </div>

        {/* Camel 3 (Trailing 2 - Dark Brown) */}
        <div
          className="absolute bottom-4 sm:bottom-6 animate-caravan-walk"
          style={{
        ...
        >
          <div className="animate-camel-gait" style={{ animationDelay: '-1.4s' }}>
            <CamelSvg isLeader={false} saddleColor="#3A2116" accentColor="#D4AF37" />
          </div>
        </div>

        {/* Camel 4 (Trailing 3 - Dark Brown / Gold Highlight) */}
        <div
          className="absolute bottom-4 sm:bottom-6 animate-caravan-walk"
          style={{
        ...
        >
          <div className="animate-camel-gait" style={{ animationDelay: '-0.4s' }}>
            <CamelSvg isLeader={false} saddleColor="#3A2116" accentColor="#F2D675" />
          </div>
        </div>
      </div>
    </div>
